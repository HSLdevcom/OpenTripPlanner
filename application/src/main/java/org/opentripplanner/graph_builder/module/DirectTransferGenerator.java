...
public class DirectTransferGenerator implements GraphBuilderModule {
  ...
  public void buildGraph() {
    ...
    // This could be calculated from transferByStop for more accuracy.
    LOG.info(
